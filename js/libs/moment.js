...
// TODO: Use [].sort instead?
  ...
  function Duration(duration) {
    var normalizedInput = normalizeObjectUnits(duration), years = normalizedInput.year || 0,
      quarters = normalizedInput.quarter || 0, months = normalizedInput.month || 0, weeks = normalizedInput.week || 0,
      days = normalizedInput.day || 0, hours = normalizedInput.hour || 0, minutes = normalizedInput.minute || 0,
...
// TODO: remove 'name' arg after deprecation is removed
  ...
  function monthDiff(a, b) {
    ...
    var wholeMonthDiff = ((b.year() - a.year()) * 12) + (b.month() - a.month()), // b is in (anchor - 1 month, anchor + 1
                                                                             // month)
...
!function (t, e) {
  ...
  return function (t) {
    ...
    "use strict";
    t.exports = n(15)() ? Symbol : n(17);
  }, function (e, n) {
    e.exports = t;
  }, function (t, e, n) {
    "use strict";
    var r, o = n(3), i = n(10), u = n(6), a = n(12);
    ...
    "use strict";
    t.exports = n(4)() ? Object.assign : n(5);
  }, function (t, e, n) {
    "use strict";
    t.exports = function () {
    ...
    "use strict";
    var r = Array.prototype.forEach, o = Object.create, i = function (t, e) {
      var n;
      for (n in t) {
        e[n] = t[n];
      }
    ...
    "use strict";
    t.exports = n(13)() ? String.prototype.contains : n(14);
  }, function (t, e, n) {
    "use strict";
    var r = "razdwatrzy";
    t.exports = function () {
    ...
    "use strict";
    var r, o, i, u, a = n(2), s = n(18), c = Object.create, f = Object.defineProperties, l = Object.defineProperty,
      v = Object.prototype, p = c(null);
    if ("function" == typeof Symbol) {
      r = Symbol;
      try {
        String(r()), u = !0;
    ...
    function u(t) {
      return t.range = function (e, n) {
        var r = this;
        return y.hasOwnProperty(e) ? new d(t(r).startOf(e), t(r).endOf(e)) : new d(e, n);
      }, t.fn.range = t.range, t.range.constructor = d, t.fn.within = function (t) {
        return t.contains(this.toDate());
      }, t;
    }

    Object.defineProperty(e, "__esModule", {value: !0}), e.DateRange = void 0;
    var a = function () {
      function t(t, e) {
    ...
    var f = n(1), l = r(f), v = n(0), p = r(v), y = {
      ...
      minute: !0,
      second: !0
    }, d = e.DateRange = function () {
      function t(e, n) {
        i(this, t);
        var r = e, o = n;
        if (1 === arguments.length || void 0 === n) {
          if ("object" === ("undefined" == typeof e ? "undefined" : s(e)) && 2 === e.length) {
            var u = a(e, 2);
            r = u[0], o = u[1];
          } else if ("string" == typeof e) {
            var c = e.split("/"), f = a(c, 2);
            r = f[0], o = f[1];
          }
        }
        this.start = null === r ? (0, l.default)(-864e13) : (0, l.default)(r), this.end = null === o ? (0, l.default)(864e13) : (0, l.default)(o);
      }
      ...
      return c(t, [{
        ...
        key: "add",
        value: function (t) {
          return this.overlaps(t) ? new this.constructor(l.default.min(this.start, t.start), l.default.max(this.end, t.end)) : null;
        }
      }, {
        key: "by",
        value: function (t) {
          ...
          return o({}, p.default.iterator, function () {
            var r = e.exclusive || !1, o = e.step || 1, i = Math.abs(n.start.diff(n.end, t)) / o, u = 0;
            return {
              next: function () {
                var e = n.start.clone().add(u * o, t), a = r ? !(u < i) : !(u <= i);
                return u++, {
                  done: a,
                  value: a ? void 0 : e
                };
        ...
        value: function (t) {
          var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {
              exclusive: !1,
              step: 1
            }, n = this, r = e.step || 1, i = this.valueOf() / t.valueOf() / r, u = e.exclusive || !1, a = Math.floor(i),
            s = 0;
          return o({}, p.default.iterator, function () {
            return a === 1 / 0 ? {done: !0} : {
              next: function () {
                var e = (0, l.default)(n.start.valueOf() + t.valueOf() * s * r),
                  o = a === i && u ? !(s < a) : !(s <= a);
                return s++, {
                  done: o,
                  value: o ? void 0 : e
        ...
        key: "contains",
        value: function (e) {
          var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {exclusive: !1},
            r = this.start.valueOf(), o = this.end.valueOf(), i = e.valueOf(), u = e.valueOf();
          e instanceof t && (i = e.start.valueOf(), u = e.end.valueOf());
          var a = r < i || r <= i && !n.exclusive, s = o > u || o >= u && !n.exclusive;
          return a && s;
        }
      }, {
        key: "diff",
        ...
        value: function (t) {
          ...
          return e <= r && r < n && n < o ? new this.constructor(r, n) : r < e && e < o && o <= n ? new this.constructor(e, o) : r < e && e <= n && n < o ? this : e <= r && r <= o && o <= n ? t : null;
        }
      }, {
        key: "isEqual",
        value: function (t) {
        ...
        value: function (t) {
          ...
          return o({}, p.default.iterator, function () {
            ...
            return {
              next: function () {
                var e = n.end.clone().subtract(u * o, t), a = r ? !(u < i) : !(u <= i);
                return u++, {
                  done: a,
                  value: a ? void 0 : e
                };
        ...
        value: function (t) {
          ...
          return o({}, p.default.iterator, function () {
            return a === 1 / 0 ? {done: !0} : {
              next: function () {
                var e = (0, l.default)(n.end.valueOf() - t.valueOf() * s * r), o = a === i && u ? !(s < a) : !(s <= a);
                return s++, {
                  done: o,
                  value: o ? void 0 : e
                };
